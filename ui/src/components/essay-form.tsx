...
export function EssayForm() {
  ...
  const [llmFeedback, setLlmFeedback] = useState<Competency[]>([])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setLlmFeedback(await evaluateEssay(essayTopic, essayContent, selectedModel) as Competency[])
    } finally {
      setIsLoading(false)
  ...
  return (
    <>
      ...
      {showFeedback ? 
        <EssayFeedback topic={essayTopic} competencies={llmFeedback} onBack={() => setShowFeedback(false)} /> :
        (
